...
class TalkSportAdapter(articles: List<Article>, sportNews: TalkSports) : RecyclerView.Adapter<CustomViewHolder>() {
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, i: Int): CustomViewHolder {
        val itemView = LayoutInflater.from(viewGroup.context).inflate(R.layout.talksport_list, null) as View
