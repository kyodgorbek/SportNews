...
class FoxSportsAdapter(internal var articles: List<Article>?, sportNews: FoxSports) : RecyclerView.Adapter<CustomViewHolder>() {

    private var myClipboard: ClipboardManager? = null
    private var myClip: ClipData? = null

    override fun onCreateViewHolder(viewGroup: ViewGroup, i: Int): CustomViewHolder {
        val itemView = LayoutInflater.from(viewGroup.context).inflate(R.layout.foxsport_list, null)
