...
import edgar.yodgorbek.yangiliklar.adapter.FootballItaliaAdapter.CustomViewHolder
...
class FootballItaliaAdapter(internal var articles: List<Article>?, footballItalia: FootballItalia) : RecyclerView.Adapter<CustomViewHolder>() {
