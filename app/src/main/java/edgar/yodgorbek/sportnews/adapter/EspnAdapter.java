...
public class EspnAdapter extends RecyclerView.Adapter<EspnAdapter.CustomViewHolder> {
    ...
    public EspnAdapter(List<Article> articles, Espn espnNews) {
    ...
    @NonNull
    @Override
    public EspnAdapter.CustomViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View itemView = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.footballitalia_list, null);
        return new EspnAdapter.CustomViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull EspnAdapter.CustomViewHolder customViewHolder, int position) {
