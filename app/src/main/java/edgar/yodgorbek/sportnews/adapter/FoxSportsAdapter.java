...
public class FoxSportsAdapter extends RecyclerView.Adapter<edgar.yodgorbek.sportnews.adapter.FoxSportsAdapter.CustomViewHolder> {
    ...
    public FoxSportsAdapter(List<Article> articles, FoxSports sportNews) {
    ...
    @NonNull
    @Override
    public FoxSportsAdapter.CustomViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View itemView = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.foxsport_list, null);
        return new FoxSportsAdapter.CustomViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull edgar.yodgorbek.sportnews.adapter.FoxSportsAdapter.CustomViewHolder customViewHolder, int position) {
