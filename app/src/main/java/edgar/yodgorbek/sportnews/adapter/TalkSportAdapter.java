...
public class TalkSportAdapter extends RecyclerView.Adapter<edgar.yodgorbek.sportnews.adapter.TalkSportAdapter.CustomViewHolder> {
    ...
    public TalkSportAdapter(List<Article> articles, TalkSports sportNews) {
    ...
    @NonNull
    @Override
    public TalkSportAdapter.CustomViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View itemView = (View) LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.talksport_list, null);
        return new TalkSportAdapter.CustomViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull edgar.yodgorbek.sportnews.adapter.TalkSportAdapter.CustomViewHolder customViewHolder, int position) {
